...
@section('content')
	<div class="row" style="margin-top: 5px;">
	    <div class="col-md-4 col-xs-12">
	        <a href="{{ route('mes_reservations.create') }}" class="btn btn-primary btn-block">  Reserverz plutôt directement</a>
	    </div>
        ...
        <div class="row">
           <div class="box-body">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="#Plus" data-toggle="tab">Parametres</a></li>
