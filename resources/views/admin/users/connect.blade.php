...
<head>
  ...
  <title>e-Reservation | Connexion</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="../../index2.html" method="post">
      ...
      <a href="#" class="help-block pull-right" style="color: red;">Mot de passe oublié ?</a>
      <div class="row">
        <div class="col-xs-7">
    ...
    <br>
    <p style="text-align: center">Vous n'avez pas de compte?<a href="{{ url('admin/users/create') }}" class="text-center"> Créez-en</a></p>
    <!-- /.social-auth-links -->
  </div>
  <!-- /.login-box-body -->
</div>
