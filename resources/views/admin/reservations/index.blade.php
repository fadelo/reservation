...
<div class="row" style="margin-top: 5px;">
    <div class="col-md-4 col-xs-12">
      <a href="{{ route('mesReservations.create') }}" class="btn btn-block btn-primary"> Nouvelle réservation</a>
    </div>
          ...
          <tbody>
            @for ($i = 0; $i < $nb; $i++)
              <tr>
                ...
                <td align="center"><a href="{{ route('mesReservations.edit', $reservations[$i]) }}"><i class="glyphicon glyphicon-edit" title="Modifier/Reporter"></i></a></td>
              </tr>
            @endfor
          </tbody>
          <tfoot>
